...
def convert_icon():
    ...
    src_path = os.path.join(assets_dir, "performance.webp")
    png_path = os.path.join(assets_dir, "icon_live.png")
    ...
    # Save as icon_live.png
    img_png.save(png_path, "PNG")
    print(f"[CONV] Successfully updated {png_path} using {src_path} with transparent alpha channel and crop!")
